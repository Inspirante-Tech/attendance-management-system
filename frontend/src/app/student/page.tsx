...
export default function StudentDashboard() {
  ...
  const [studentData] = useState(mockStudentData.studentData)
        ...
        <Card className="bg-gradient-to-r from-blue-600 to-indigo-700 text-white">
          <CardHeader className="pb-3 sm:pb-4 lg:pb-6">
            <div className="flex flex-col sm:flex-row sm:items-center space-y-3 sm:space-y-0 sm:space-x-4">
              <div className="w-12 h-12 sm:w-14 sm:h-14 lg:w-16 lg:h-16 bg-white/20 rounded-full flex items-center justify-center mx-auto sm:mx-0">                {studentData.photo_url ? (
                  <Image
              ...
              <div className="flex-1 text-center sm:text-left">
                <CardTitle className="text-white text-lg sm:text-xl lg:text-2xl">Welcome back, {studentData.name}</CardTitle>
          ...
          <CardContent className="pt-0">
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3 sm:gap-4">
              <div className="flex items-center justify-center sm:justify-start space-x-2">
                ...
                <span className="text-xs sm:text-sm truncate">{studentData.college_name}</span>
              </div>
              <div className="flex items-center justify-center sm:justify-start space-x-2">
              ...
              <div className="flex items-center justify-center sm:justify-start space-x-2 sm:col-span-2 lg:col-span-1">
                ...
                <span className="text-xs sm:text-sm truncate">{studentData.email}</span>
              </div>
            </div>
          </CardContent>
