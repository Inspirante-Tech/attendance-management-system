    ...
    return (
      <Card>
        <CardContent className="flex items-center justify-center py-8 sm:py-12">
          ...
          <span className="text-gray-600 text-sm sm:text-base">Loading attendance statistics...</span>
        </CardContent>
      </Card>
    )
  }
          ...
          <div className="space-y-4">
            ...
            <div className="grid grid-cols-2 gap-4">
              <div className="text-center p-3 bg-green-50 rounded-lg border border-green-200">
                <div className="text-2xl font-bold text-green-600">{overallStats.total_present}</div>
                <div className="text-xs text-green-700">Present</div>
              </div>
              <div className="text-center p-3 bg-red-50 rounded-lg border border-red-200">
                <div className="text-2xl font-bold text-red-600">{overallStats.total_absent}</div>
        ...
        <Card>
          <CardContent className="flex items-center p-3 sm:p-4 lg:p-6">
            <div className="flex items-center space-x-2 sm:space-x-4">
              ...
              <div>
                <p className="text-lg sm:text-2xl font-bold text-green-600">{overallStats.total_present}</p>
                <p className="text-xs sm:text-sm text-gray-600">Classes Attended</p>
              </div>
            </div>
          </CardContent>
        </Card>
        ...
        <Card>
          <CardContent className="flex items-center p-3 sm:p-4 lg:p-6">
            <div className="flex items-center space-x-2 sm:space-x-4">
              ...
              <div>
                <p className="text-lg sm:text-2xl font-bold text-red-600">{overallStats.total_absent}</p>
                <p className="text-xs sm:text-sm text-gray-600">Classes Missed</p>
              </div>
            </div>
          </CardContent>
        </Card>
        ...
        <Card>
          <CardContent className="flex items-center p-3 sm:p-4 lg:p-6">
            <div className="flex items-center space-x-2 sm:space-x-4">
              ...
              <div>
                <p className="text-lg sm:text-2xl font-bold text-blue-600">{overallStats.total_classes}</p>
          ...
          <CardContent className="flex items-center p-3 sm:p-4 lg:p-6">
            <div className="flex items-center space-x-2 sm:space-x-4">
              ...
              <div>
                ...
                <p className="text-xs sm:text-sm text-gray-600">Overall Percentage</p>
              </div>
            </div>
          </CardContent>        </Card>
      </div>      {/* Subject-wise Attendance */}
      <Card>        <CardHeader className="pb-3 sm:pb-4">
          <div className="flex items-center justify-between">
            <div>
              <CardTitle className="text-base sm:text-lg">Subject-wise Attendance</CardTitle>
              <CardDescription className="text-xs sm:text-sm">Attendance percentage for each subject</CardDescription>
            </div>
          </div>
            ...
            <div className="inline-block min-w-full align-middle">
              <table className="min-w-full text-xs sm:text-sm">              <thead>
                <tr className="border-b border-gray-200">
                  <th className="text-left py-2 sm:py-3 px-1 sm:px-2 font-medium text-gray-700 lg:hidden">Course</th>
                  <th className="hidden lg:table-cell text-left py-2 sm:py-3 px-1 sm:px-2 font-medium text-gray-700">Course Code</th>
                  <th className="hidden lg:table-cell text-left py-2 sm:py-3 px-1 sm:px-2 font-medium text-gray-700">Course Name</th>
                  <th className="text-center py-2 sm:py-3 px-1 sm:px-2 font-medium text-gray-700">Present</th>
                  <th className="text-center py-2 sm:py-3 px-1 sm:px-2 font-medium text-gray-700">Absent</th>
                  <th className="text-center py-2 sm:py-3 px-1 sm:px-2 font-medium text-gray-700">Total</th>
                  <th className="text-center py-2 sm:py-3 px-1 sm:px-2 font-medium text-gray-700">%</th>
                </tr>
              </thead>              <tbody>
                  ...
                  <tr key={index} className="border-b border-gray-100 hover:bg-gray-50">
                    ...
                    <td className="py-2 sm:py-3 px-1 sm:px-2 lg:hidden">
                      <div className="min-w-[120px] sm:min-w-[140px]">
                        <div className="font-medium text-gray-900 text-xs sm:text-sm">{course.course_code}</div>
                        <div className="text-gray-600 text-xs truncate">{course.course_name}</div>
                      </div>
                    </td>
                    ...
                    <td className="text-center py-2 sm:py-3 px-1 sm:px-2">
                      <div className="flex flex-col items-center space-y-1">
                        <span className="font-medium text-xs sm:text-sm">{course.percentage.toFixed(1)}%</span>
                        <div className="w-12 sm:w-16 bg-gray-200 rounded-full h-1 sm:h-1.5">
                          <div 
                            className={`h-1 sm:h-1.5 rounded-full transition-all duration-200 ${
                              ...
                              course.status === 'warning' ? 'bg-yellow-500' :
                              'bg-red-500'
                            }`}
