...
async function redistributeNMAMITstudents() {
  try {
    ...
    console.log(
      `Section A offering has ${sectionAOffering.enrollments.length} enrollments\n`
    );
    ...
    console.log(
      `✅ Moved ${studentsBySection.B.length} students to Section B offering`
    );
    ...
    console.log(
      `✅ Moved ${studentsBySection.C.length} students to Section C offering\n`
    );
