...
async function getAnalyticsDataForExport(filters) {
...
// Export as CSV
router.get('/csv', auth_1.authenticateToken, async (req, res) => {
    try {
        const filters = {
...
// Export as JSON
router.get('/json', auth_1.authenticateToken, async (req, res) => {
    try {
        const filters = {
            academicYear: req.query.academicYear
        };
...
router.get('/excel', auth_1.authenticateToken, async (req, res) => {
    try {
        const filters = {
            academicYear: req.query.academicYear
        };
...
router.get('/pdf', auth_1.authenticateToken, async (req, res) => {
    try {
        const filters = {
            academicYear: req.query.academicYear
        };
