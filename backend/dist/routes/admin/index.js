...
const excelImportRoutes_1 = __importDefault(require("./excelImportRoutes"));
const exportRoutes_1 = __importDefault(require("./exportRoutes"));
const dumpRoutes_1 = __importDefault(require("./dumpRoutes"));
...
router.use('/course', auth_1.requireTeacher);
// Apply admin-only middleware to remaining routes
router.use(auth_1.requireAdmin);
// Mount all admin route modules
router.use('/', importRoutes_1.default);
router.use('/', excelImportRoutes_1.default);
router.use('/', exportRoutes_1.default);
router.use('/', dumpRoutes_1.default);
