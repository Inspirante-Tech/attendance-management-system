 ...
 */
async function autoEnrollStudentForSemester(studentId, semester) {
    const result = {
        success: false,
 ...
 * @returns AutoEnrollmentResult with details of the enrollment process
 */
async function autoEnrollFirstYearStudent(studentId) {
 ...
 * @returns AutoEnrollmentResult with details of the enrollment process
 */
async function autoEnrollStudentBySemester(studentId, targetSemester) {
    const result = {
        success: false,
        enrollmentsCreated: 0,
        errors: [],
 ...
 */
async function getAvailableCoursesForSemester(collegeId, departmentId, semester, academicYearId) {
    const prisma = database_1.default.getInstance();
 ...
 */
async function getCoursesBySemester(collegeId, departmentId, academicYearId) {
    const prisma = database_1.default.getInstance();
    let targetAcademicYear = academicYearId;
    if (!targetAcademicYear) {
        const activeAcademicYear = await prisma.academic_years.findFirst({
 ...
 * @returns AutoEnrollmentResult with details of the enrollment process
 */
async function promoteStudentToNextSemester(studentId) {
    const result = {
        success: false,
        enrollmentsCreated: 0,
        errors: [],
