...
exports.hasTheoryMarksUpdate = hasTheoryMarksUpdate;
exports.hasLabMarksUpdate = hasLabMarksUpdate;
exports.buildTheoryMarksData = buildTheoryMarksData;
exports.buildLabMarksData = buildLabMarksData;
exports.transformToMarksData = transformToMarksData;
exports.buildMarksWhereClause = buildMarksWhereClause;
/**
 ...
 */
function hasTheoryMarksUpdate(markData) {
 ...
 */
function hasLabMarksUpdate(markData) {
 ...
 */
function buildTheoryMarksData(markData, currentMarks) {
 ...
 */
function buildLabMarksData(markData) {
    const labMarkData = {
        lastUpdatedAt: new Date()
    };
    // Map request fields to database fields
 ...
 */
function transformToMarksData(enrollment) {
    return {
        id: enrollment.id,
 ...
 */
function formatTheoryMarks(marks) {
    return {
        id: marks.id,
 ...
 */
function buildMarksWhereClause(params) {
    const whereClause = {};
